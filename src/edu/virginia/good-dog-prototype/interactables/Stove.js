...
class Stove extends InteractSprite
{
	constructor(isRight)
	{
	    ...
	    super(id, foldername, 3, ['start', 'broken', 'burn'], [1, 0, 2], [2, 0, 2], [false, true, false], [1.0, 1.0, 1.6], [true, false, true], ["Benign", "Open", "Burn"]); // Id, foldername, nPics, names, machine, poopables, suppressions, events
