  ...
  update(pressedKeys, gamepads) {
    if (this.parent) {
      ...
      if (this.path.length > 1) {
        ...
        this.applyForce(new Vec2(xDir * this.parent.clock.getElapsedTime() / 12.0 * this.speed(), 0));
        this.applyForce(new Vec2(0, yDir * this.parent.clock.getElapsedTime() / 12.0 * this.speed()));
      }
